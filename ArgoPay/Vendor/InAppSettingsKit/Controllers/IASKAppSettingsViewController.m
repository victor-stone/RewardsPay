...
- (void)viewWillAppear:(BOOL)animated {
    ...
    if ([self.delegate respondsToSelector:@selector(settingsViewControllerWillAppear:)]) {
...
- (void)setHiddenKeys:(NSSet*)theHiddenKeys animated:(BOOL)animated {
	...
	IASKAppSettingsViewController *childViewController = (self.viewList)[kIASKSpecifierChildViewControllerIndex][@"viewController"];
...
- (UITableViewCell*)newCellForIdentifier:(NSString*)identifier {
    ...
    cell.detailTextLabel.minimumScaleFactor = kIASKMinimumFontSize / label.font.pointSize;
    label = cell.textLabel;
    cell.textLabel.minimumScaleFactor = kIASKMinimumFontSize / label.font.pointSize;
	return cell;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	if ([specifier.type isEqualToString:kIASKPSToggleSwitchSpecifier]) {
        ...
        cell.accessoryView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"exitToBrowser.png"]];
    ...
    cell.detailTextLabel.font = [UIFont fontWithName:@"GillSans" size:12];
    cell.textLabel.font = [UIFont fontWithName:@"GillSans-Bold" size:15];
